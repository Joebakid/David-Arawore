const services = [
  {
    ...
    description:
      "Full-spectrum community building across Discord, Telegram, and X. From onboarding flows and moderation systems to engagement programs that turn lurkers into advocates.",
  ...
  },
  {
    ...
    description:
      "Narrative-driven content that educates, builds trust, and converts. I bridge the gap between complex blockchain concepts and the humans who need to understand them.",
  ...
  },
  {
    ...
    description:
      "Compelling stories that align your protocol's mission with community values. Whether it's launch campaigns, ecosystem narratives, or founder positioning — story is the strategy.",
  ...
  },
  {
    ...
    description:
      "Data-informed growth strategy for early-stage Web3 projects. I help teams identify levers, set community KPIs, and execute experiments that compound over time.",
          ...
          >
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="space-y-1">
                <p className="text-xs font-mono text-[#A855F7]/60 tracking-widest">{s.number}</p>
                <h3 className="text-lg font-bold text-white group-hover:text-[#C3A9F5] transition-colors">
                  {s.title}
                </h3>
              </div>
              <span className="text-[#A855F7]/30 group-hover:text-[#A855F7] transition-colors text-2xl leading-none mt-0.5">
                ↗
              </span>
            </div>
